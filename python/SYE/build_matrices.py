from calculate_entries import match_result_weighted, weight_match_score, match_score, match_result, raw_match_score
...
def build_matrices(team_games, records):
    ...
    return results_matrix, weighted_results_matrix, scores_matrix, weighted_scores_matrix, raw_scores_matrix